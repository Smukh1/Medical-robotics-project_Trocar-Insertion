...
public class MainTrocarTask_2 extends RoboticsAPIApplication {
 ...
 // Taking to the gripper to tool changing position from the current position.
    ...
    recorder.startRecording(configuration);

    logger.info(" Proceding with 2nd Trocar " ); 
 ...
 // Approaching to 'Approach2' position
    Frame approach = world.findFrame("Approach2");
 ...
 // Approaching to 'Insert1' position with screwing motion
    Frame insert = world.findFrame("Approach2/A2Insert1");
 ...
 // Approaching to 'Insert2' position with screwing motion    
    Frame insert2 = world.findFrame("Approach2/A2Insert2");
...
// Approaching to 'Insert3' position with screwing motion
    Frame insert3 = world.findFrame("Approach2/A2Insert3");
...
// Approaching to 'Insert4' position with screwing motion
    Frame insert4 = world.findFrame("Approach2/A2Insert4");
    ...
    TimeUnit.SECONDS.sleep(waiter-10); // To release the trocar
    
    logger.info(" 2nd Trocar Installed in Place " );

    
 // Retracting slowly to approach position 
    Frame approach2 = world.findFrame("Approach2");

    _lbr.getFlange().move(ptp(approach2).setJointVelocityRel(0.2));
